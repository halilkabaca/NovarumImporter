 ...
 * @subpackage Novarumimporter/public
 */
...
class Novarumimporter_Public {
	...
	public function novarumimporter_enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/novarumimporter-public.css', array(), $this->version, 'all' );
	...
	public function novarumimporter_enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/novarumimporter-public.js', array( 'jquery' ), $this->version, false );
